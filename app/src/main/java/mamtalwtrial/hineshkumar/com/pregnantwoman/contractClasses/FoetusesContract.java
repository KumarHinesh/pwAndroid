...
public class FoetusesContract {
    ...
    private String _ID = "";
    private String UID = "";  // primary key of foetuses
    private String UUID = ""; // forign key of form crf1
    ...
    public FoetusesContract Sync(JSONObject jsonObject) throws JSONException {
        ...
        this.crf1 = jsonObject.getString(FormsTable.COLUMN_CRF1_ID);
    ...
    public FoetusesContract Hydrate(Cursor cursor) {
        ...
        this.crf1 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CRF1_ID));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(FormsTable.COLUMN_CRF1_ID, this.crf1 == null ? JSONObject.NULL : this.crf1);
...
*/
    ...
    public static abstract class FormsTable /*implements BaseColumns */ {
        ...
        public static final String COLUMN_CRF1_ID = "crf1";
        ...
        public static String _URL = "foetuses.php";
    }
}
