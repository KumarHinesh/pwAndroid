package mamtalwtrial.hineshkumar.com.pregnantwoman.fragments.crf5Fragments.crf5aFragments;
...
import mamtalwtrial.hineshkumar.com.pregnantwoman.activities.CRF4Activity;
import mamtalwtrial.hineshkumar.com.pregnantwoman.fragments.crf4Fragments.Crf4Q22Fragments;


public class Crf5PwinfoFragment extends Fragment {
...
//                    int visitNo = Integer.parseInt(CRF2Activity.formCrf2DTO.getQ17());
                    ...
                    switch (1) {
                        ...
                        case 1:
                            ...
                            // CRF4Activity.fragmentManager.beginTransaction().replace(R.id.crf4_frame, new Crf4Q22Fragments(), null).addToBackStack(null).commit();
